...
class Announcement:
    ...
    announcement_responses: list["Response"] = field(default_factory=list)
    announcement_complaints: list["Complaints"] = field(default_factory=list)
    announcement_conversations: list["Conversation"] = field(default_factory=list)
    announcement_notifications: list["Notification"] = field(default_factory=list)
